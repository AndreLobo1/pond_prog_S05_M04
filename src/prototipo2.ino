...
const char* client_id = "esp32_t12_g04_b"; // Identificador único para o dispositivo B

// Tópicos MQTT
const char* topic_modo_noturno = "/v1.6/devices/esp32_t12_g04_b/modo_noturno";
const char* topic_ldr = "/v1.6/devices/esp32_t12_g04_b/ldr_valor";
const char* topic_led_verde = "/v1.6/devices/esp32_t12_g04_b/led_verde"; 
